...
import ChallengeTable1 from "@/components/ChallengeTables/ChallengeTable1.vue";
import ChallengeTableCreate from "@/components/ChallengeTables/ChallengeTableCreate.vue";
    ...
    >
      ...
      <div class="w-[277px] lg:w[400px] flex flex-col gap-2">
        ...
        <ul>
          ...
          <li>Mike Mike - <span class="text-[#608CFF]">run!</span></li>
          <li>3rd Player - <span class="text-[#608CFF]">Pending.</span></li>
        </ul>
      </div>
    </ScreenLayout>
  </PrimaryLayout>
