...
<template>
  <SubscreenLayout>
    ...
    <div class="flex flex-row gap-1 lg:gap-2 w-full">
      <div class="w-3/5">
        ...
        >
          <div class="flex items-center w-full">
            <h1
              class="font-nano-pix text-2xl lg:text-3xl text-black bg-[#8578A0] rounded-2xl py-1 lg:py-2 pl-5 lg:pl-4 2xl:pl-16 w-full relative text-left"
            >
              join
            </h1>
            <img
              src="../../assets/ticket-icon-black-2-dark-purple.png"
              alt="ticket"
      ...
      <div class="w-1/5">
        ...
        >
          <div class="flex items-center w-full">
            <h1
              class="font-nano-pix text-2xl lg:text-3xl text-black bg-[#C5AAFF] rounded-2xl py-1 lg:py-2 justify-center flex w-full text-left"
            >
              info
            </h1>
          </div>
    ...
    <div class="mt-2.5 lg:mt-4 leading-none">
      <button
        @click="switchToScreen4()"
        class="text-left uppercase text-sm text-[#C5AAFF]"
      >
        <div class="flex flex-row gap-2 text-xs">
          <p>View Past Contests</p>
          <svg
